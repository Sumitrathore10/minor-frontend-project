  ...
  return (
    <div className="w-full h-full p-[1%]">
      <button
        ...
        className="text-red-500 font-sans font-semibold hover:scale-110 border-gray-400 border-2 px-3 py-2 shadow-black shadow-sm rounded-md"
      >
        Go Back
      </button>
      {product ? (
        <>
          <div className="w-[80%] h-[95%]  shadow-lg shadow-black rounded-md m-auto flex justify-center items-center gap-[5%] p-[8%]">
            <img
